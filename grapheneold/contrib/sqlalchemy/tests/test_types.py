...
from grapheneold.contrib.sqlalchemy.types import (SQLAlchemyNode,
...
# @patch('grapheneold.contrib.sqlalchemy.tests.models.Article.filter', return_value=Article(id=1))
