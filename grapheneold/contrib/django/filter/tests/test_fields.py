...
from grapheneold import ObjectType, Schema
from grapheneold.contrib.django import DjangoNode
from grapheneold.contrib.django.forms import (GlobalIDFormField,
                                           GlobalIDMultipleChoiceField)
from grapheneold.contrib.django.tests.models import Article, Pet, Reporter
from grapheneold.contrib.django.utils import DJANGO_FILTER_INSTALLED
from grapheneold.relay import NodeField

pytestmark = []
if DJANGO_FILTER_INSTALLED:
    import django_filters
    from grapheneold.contrib.django.filter import (GlobalIDFilter, DjangoFilterConnectionField,
                                                GlobalIDMultipleChoiceFilter)
    from grapheneold.contrib.django.filter.tests.filters import ArticleFilter, PetFilter
else:
