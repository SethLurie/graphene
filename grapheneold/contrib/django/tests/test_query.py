...
def test_should_query_only_fields():
    with raises(Exception):
        ...
        schema = grapheneold.Schema(query=ReporterType)
        query = '''
            query ReporterQuery {
              articles
            }
...
def test_should_query_well():
    ...
    class Query(grapheneold.ObjectType):
        reporter = grapheneold.Field(ReporterType)
...
def test_should_query_postgres_fields():
    ...
    class Query(grapheneold.ObjectType):
        event = grapheneold.Field(EventType)
...
def test_should_node():
    ...
    class Query(grapheneold.ObjectType):
        ...
        reporter = grapheneold.Field(ReporterNode)
        article = grapheneold.Field(ArticleNode)
