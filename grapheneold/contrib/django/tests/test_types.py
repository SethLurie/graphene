from grapheneold.libraries.graphql.type import GraphQLObjectType
from mock import patch

from grapheneold import Schema, Interface
from grapheneold.contrib.django.types import DjangoNode, DjangoObjectType
from grapheneold.core.fields import Field
from grapheneold.core.types.scalars import Int
from grapheneold.relay.fields import GlobalIDField
...
@patch('grapheneold.contrib.django.tests.models.Article.objects.get', return_value=Article(id=1))
